 ...
 *  onShow: onShowCallback,  // The callback that run before showign the modal, retrun false to cancel
 *  onClose: onCloseCallback //  The callback that run before hide, return false to cancel
 * }, 'Here is the content', 'noather content...');
 */
...
// is to set how many ms the modal box disapear
